  ...
  function r() {
    ...
    function S(e, t, a, i, r, n, o, c, l, s, d, p, m, u, h, g, v, f) {
      var x = f
        ...
        b = '#009e73';
      l < 0 && (b = '#d94040'),
        (l = L.toLocaleString(l, { minDecimalPlaces: 2, maxDecimalPlaces: 2 })),
        (valTickerHTML = m ? '(' + a + ')' : ''),
        (valPrice = n ? P(n, i) : '?'),
        (valPercentHTML = l
          ? '<span style="color:' + b + '">(' + l + '%)'
          : ''),
      ...
      var y =
          ...
          e,
        w =
          '<div style="border:2px solid #e1e5ea;border-radius: 10px;font-family: Roboto;min-width:285px;">    <div>        <div style="float:right;width:67%;border: none;text-align:left;padding:5px 0px;line-height:' +
          mainLineHeight +
          'px;">            <span style="font-size: 18px;"><span>' +
          t +
          ' ' +
          valTickerHTML +
          '</span></span> <br>            <span style="font-size: 16px;">' +
          valPrice +
          ' ' +
          i +
          ' ' +
          ...
          '</span></span>            ' +
          secondaryHTML +
          '        </div>        <div style="text-align:center;padding:5px 0px;width:33%;"><img src="' +
          x +
          '"></div>    </div>';
      return (
        ...
        (w +=
          '    <div style="text-align:center;clear:both;font-size:10px;font-style:italic;"> </div></div>')
      );
    }
